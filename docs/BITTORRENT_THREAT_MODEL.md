...
contact, outbound TCP peers, and peer exchange only after disclosure. SOCKS routing, DHT, uTP,
incoming connections, port mapping, automatic capture, and background seeding remain deferred.
